...
async function buildHtml(inspection: Inspection): Promise<string> {
    ...
    <div class="page">
      <div class="page-inner">
        ...
        <div class="photo-wrap">
          ${uri
            ? `<div style="text-align:center;"><div style="position:relative;display:inline-block;line-height:0;"><img src="${uri}" class="pic-img"/>${drawSvg}${annotSvg}</div></div>`
  ...
  const css = `<style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .photo-wrap { border-radius: 8px; border: 1px solid #ddd; margin-bottom: 16px; text-align: center; background: #fafafa; padding: 8px; }
    .pic-img { display: block; max-width: 576px; max-height: 384px; width: auto; height: auto; margin: 0 auto; }
